...
namespace XFramework.Repositories
{
    public class DbContextScope : IDbContextScope
    {
        ...
        public void RefreshEntitiesInParentScope(IEnumerable entities)
        {
            ...
            {
                var correspondingParentContext = _parentScope._dbContexts.InitializedDbContexts.Values.SingleOrDefault(
                    parentContext => parentContext.GetType() == contextInCurrentScope.GetType()) as IObjectContextAdapter;
